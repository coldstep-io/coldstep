...
func (s *runStats) snapshotSummary(kernel string, bpf []telemetry.BPFStatus) telemetry.Summary {
	...
	return telemetry.Summary{
		...
		TLSConfidenceFull:              uint64(s.tlsConfidenceFullN),
		TLSConfidencePartial:           uint64(s.tlsConfidencePartialN),
		TLSConfidenceInferred:          uint64(s.tlsConfidenceInferredN),
		TLSConfidenceUnknown:           uint64(s.tlsConfidenceUnknownN),
