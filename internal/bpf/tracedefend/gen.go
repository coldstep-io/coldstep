// Package tracedefend loads the trace_defend.bpf.c BPF object via
// cilium/ebpf bpf2go-generated bindings.
//
// Loader pattern: direct `//go:generate` line — no per-arch flags needed.
// trace_defend.bpf.c attaches `cgroup/connect4` and `cgroup/sendmsg4`
...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go@v0.21.0 -cc clang -no-strip -target bpfel,bpfeb -cflags "-O2 -g -Wall -Werror -I../../../bpf -I/usr/include/bpf" Tracedefend ../../../bpf/trace_defend.bpf.c -- -I../../../bpf -I/usr/include/bpf
