...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go@v0.22.0 -cc clang -no-strip -target bpfel -cflags "-O2 -g -Wall -Werror -I../../../bpf -I/usr/include/bpf" Tracefork ../../../bpf/trace_fork.bpf.c -- -I../../../bpf -I/usr/include/bpf
