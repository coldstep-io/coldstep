...
5. **Pinning for consumers** — downstream workflows should use a **release tag** (for example **`coldstep-io/coldstep@v1.2.0`**), not **`@main`**, unless they intentionally track head.
