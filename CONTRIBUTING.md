...
6. **Pinning for consumers** — downstream workflows should use a **release tag** (for example **`coldstep-io/coldstep@v0.4.1`**), not **`@main`**, unless they intentionally track head.
