...
6. **Pinning for consumers** — downstream workflows should use a **release tag** (for example **`coldstep-io/coldstep@v0.5.3`**), not **`@main`**, unless they intentionally track head.
