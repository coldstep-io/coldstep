...
go generate ./internal/bpf/defend/...
go generate ./internal/bpf/tracedns/...
go generate ./internal/bpf/tracefs/...
go generate ./internal/bpf/tracebpfaudit/...
go generate ./internal/bpf/tracektls/...
go generate ./internal/bpf/traceipv6/...
go build -trimpath -ldflags="-s -w" -o bin/coldstep ./cmd/coldstep
go build -trimpath -ldflags="-s -w" -o bin/coldstep-action ./cmd/coldstep-action
