...
async function startAgent() {
  ...
  fs4.mkdirSync(path2.join(actionPath, "bin"), { recursive: true });
...
function readDetectDigest() {
  ...
  try {
    return fs5.readFileSync(logPath, "utf8");
  } catch (e) {
